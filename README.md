...
> [!NOTE]
> To setup this example in Windows, go and follow **Windows-setup.md** file content instructions.
> 
> To view user menu options, go to the **User-menu-options.md** file content.
> 
> To view the High Level architecture, go to **HL-architecture.md** file content.
